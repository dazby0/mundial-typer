    ...
    <div className="rounded-[2rem] bg-foreground p-6 text-background shadow-sm">
      <div className="flex flex-col gap-5">
        <div className="min-w-0">
          ...
          <div className="mt-5 grid gap-4 grid-cols-[1fr_auto_1fr] items-center">
          ...
          <div className="mt-4 flex flex-wrap gap-2 text-sm text-background/70">
        ...
        >
          <Link href={`/matches/${match.id}`}>Obstaw teraz</Link>
        </Button>
      </div>
    </div>
  );
